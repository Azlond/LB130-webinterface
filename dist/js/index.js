...
class Light {
    ...
    constructor() {
        ...
        this.brightnessSlider.addEventListener('input', () => {
            this.brightnessLight.style.fill = `rgba(255, 255, 0, ${this.value / 100})`;
        ...
        this.colorTempSlider.addEventListener('input', function () {
            this.colorTempLight.style.fill = colorTempToHex[this.value];
    ...
    */
     ...
     */
    updateGui(response) {
        let colorTemp = (response.color_temp === undefined) ? response.dft_on_state.color_temp : response.color_temp;
        ...
        const brightness = (response.brightness === undefined) ? response.dft_on_state.brightness : response.brightness;
        ...
        const hue = (response.hue === undefined) ? response.dft_on_state.hue : response.hue;
        const saturation = (response.saturation === undefined) ? response.dft_on_state.saturation : response.saturation;
