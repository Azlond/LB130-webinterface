...
class Light {
  ...
  constructor() {
    ...
    /*Brightness */
    this.brightnessLight = document
      .getElementById("whiteLightBrightnessSVG")
      .contentDocument.getElementById("innerBulb");
    ...
    /* Color Temperature*/
    this.colorTempLight = document
      .getElementById("whiteLightColorTempSVG")
      .contentDocument.getElementById("innerBulb");
    ...
    this.colorLight = document
      .getElementById("colorLightSVG")
      .contentDocument.getElementById("innerBulb");
  ...
  initColorPicker() {
    ...
    canvas.addEventListener("mouseenter", (_e) => {
  ...
  async updateLight(color) {
    const hsv = this.RGBtoHSV(
      parseInt(document.getElementById("rVal").value, 10),
      parseInt(document.getElementById("gVal").value, 10),
      parseInt(document.getElementById("bVal").value, 10),
    );
    const packet = {
      mode: "normal",
  ...
  updateGui(response) {
    let colorTemp =
      response.color_temp !== undefined ? response.color_temp : response.dft_on_state.color_temp;
    ...
    const brightness =
      response.brightness !== undefined ? response.brightness : response.dft_on_state.brightness;
    ...
    if (!this.mouseInCanvas) {
      ...
      const saturation =
        response.saturation !== undefined ? response.saturation : response.dft_on_state.saturation;
